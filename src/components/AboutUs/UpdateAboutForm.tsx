...
const UpdateAboutForm = ({ description }: TProps) => {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      ...
      <button
        type="submit"
        className="w-full flex justify-center items-center gap-x-2 bg-primary hover:bg-[#2b4773] text-white py-2 rounded-md font-semibold transition-colors duration-100"
      >
        {isLoading ? (
          <>
