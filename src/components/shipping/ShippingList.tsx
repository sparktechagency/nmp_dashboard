...
const ShippingList = () => {
  ...
  const { data, isLoading, isFetching, isError } = useGetShippingCostsQuery([
    ...
    <>
      <div className="p-4 flex justify-between gap-x-2">
        <div className="flex flex-col md:flex-row md:items-center gap-x-16 gap-y-4">
          <h1 className="text-lg md:text-xl font-semibold text-gray-800">Shipping Cost List</h1>
