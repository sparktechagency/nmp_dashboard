...
import { useUpdateCountDownImgMutation } from "../../../redux/features/information/informationApi";




const UpdateCountDownImgModal = () => {
  const [modalOpen, setModalOpen] = useState(false);
  const [updateCountDownImg, { isLoading, isSuccess }] = useUpdateCountDownImgMutation();
...
export default UpdateCountDownImgModal;
